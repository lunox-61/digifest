    ...
    @forelse ($posts as $postitem)
        ...
        <div class="card" style="width: 18rem;">
          ...
          <div class="card-body">
            ...
            <a href="{{asset('main-pengumuman/'.$postitem->slug)}}" class="btn btn-primary">Lihat Selengkapnya</a>
          </div>
        </div>
    @empty
...
{{--
    <a href="{{asset('main-pengumuman/'.$postitem->slug)}}" class="text-dark">{{$postitem->name}}</a>
    <p class="fs-6"><i class="fa fa-calendar"></i>{{$postitem->created_at->format('d-m-Y')}}</p>
--}}
{{--
    <a href="{{asset('main-pengumuman/'.$postitem->slug)}}" class="text-dark">{{$postitem->name}}</a>
