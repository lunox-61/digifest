...
@section('title', 'Detail Formulir Individu')
...
<div class="category-heading text-uppercase">
    <h4>Grafik Pribadi dan Hasil Jawaban</h4> 
</div>
<div>
    <p>Berikut hasil submit dari Form Partisipasi untuk {{ $formulir->nama_perusahaan }}</p> 
</div>
<hr>
    <div class="card mt-4">
    ...
    <div class="card mt-4">
        <div class="card-header">
            <h4 class="card-title">Indeks Nilai</h4>
        </div>
        <div class="card-body">
    ...
    //radar chart
    @if(isset($hasilnilai1) && isset($hasilnilai2) && isset($hasilnilai3) && isset($hasilnilai4) && isset($hasilnilai5))
...
@else
        <p>Data individu tidak ditemukan.</p>
    @endif
     @endif
</div>
@endsection